                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Penulis : <?= $nama_penulis->nama_penulis; ?></h4>
                            </div>
                        </div>
                        <?php foreach ($artikel_penulis as $row) :  ?>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    <div class="d-flex align-items-center">
                                        <!-- <img class="rounded-circle mr-2" src="<?= base_url('assets-baru') ?>/img/penulis1.png" width="25" height="25" alt=""> -->
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                ...
                                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="<?= base_url('kategori/' . $row['id_kategori']) ?>"><?= $row['nama_kategori']; ?></a>
                                        <a class="text-body" href="<?= base_url('/artikel/detail/' . $row['id_artikel'] . '/' . $row['slug']) ?>"><small><?= date('d F Y', strtotime($row['created_at'])); ?></small></a>
                                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            <div class="d-flex flex-wrap m-n1">
                                ...
                                foreach ($artikel_penulis as $row) {
