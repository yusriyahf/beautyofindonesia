...
<div class="container">
    ...
    <div class="row mt-3">
        ...
        <div class="col-12 mb-4">
            <form method="get" action="<?= base_url($lang === 'en' ? 'en/souvenirs/' . $kategoriFix->slug_kategori_oleholeh_en : 'id/oleh-oleh/' . $kategoriFix->slug_kategori_oleholeh) ?>">
        ...
        <script>
            $(document).ready(function() {
                const lang = "<?= $lang; ?>";
                const kategoriOlehOleh = "<?= $lang === 'id' ? $kategoriFix->nama_kategori_oleholeh : $kategoriFix->nama_kategori_oleholeh_en; ?>";
                ...
                function updateSectionTitle(provinsiName, kabupatenName) {
                    ...
                    if (kabupatenName && kabupatenName !== "" && kabupatenName !== "<?= lang('Blog.btnAllKabupaten') ?>") {
                        title = lang === 'id' ?
                            `Oleh-Oleh ${kategoriOlehOleh} di ${kabupatenName}` :
                            `Souvenirs of ${kategoriOlehOleh} in ${kabupatenName}`;
                    } else if (provinsiName && provinsiName !== "") {
                        title = lang === 'id' ?
                            `Oleh-Oleh ${kategoriOlehOleh} ${provinsiName}` :
                            `Souvenirs of ${kategoriOlehOleh} in ${provinsiName}`;
    ...
    <div class="pagination-container mb-4">
        <?= $pager->links('oleh', 'default_pagination') ?>
    </div>
</div>
