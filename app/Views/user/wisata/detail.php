    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <?php else : ?>
                    <img src="<?= base_url('assets-baru/img/banner_footer2.png'); ?>" alt="" width="100%" class="mb-3">
                <?php endif; ?>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <?php else : ?>
                    <img src="<?= base_url('assets-baru/img/banner_sidebar2.png'); ?>" alt="" width="100%" class="mb-3">
                <?php endif; ?>
