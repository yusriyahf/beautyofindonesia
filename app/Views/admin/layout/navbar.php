    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <ul class="nav flex-column ms-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('admin/artikeliklan') ?>">
                                    ...
                                    <span class="nav-link-text">Permintaan Tampil Iklan</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('admin/komisi') ?>">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-aspect-ratio" viewBox="0 0 16 16">
                                <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h13A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5zM1.5 3a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5z" />
                                <path d="M2 4.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1H3v2.5a.5.5 0 0 1-1 0zm12 7a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1H13V8.5a.5.5 0 0 1 1 0z" />
                        ...
                        <span class="nav-link-text">Komisi User</span>
                    </a>
                </li>
...
<!-- Tambahkan CSS untuk rotasi panah -->
<style>
    .arrow-icon {
...
<!-- JavaScript untuk animasi panah -->
<script>
    ...
    // Saat menu terbuka
    artikelMenu.addEventListener('shown.bs.collapse', function() {
