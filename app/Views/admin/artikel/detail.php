                ...
                <div class="app-card app-card-detail shadow-sm mb-4">
                    ...
                    <div class="app-card-body p-4">
                        ...
                        <div class="article-image mb-4 text-center">
                            <img src="<?= base_url('assets-baru/img/foto_artikel/' . $artikel['foto_artikel']) ?>"
                        ...
                        <div class="metadata-list">
                            ...
                            <div class="metadata-item d-flex mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold small"><?= esc($artikel['nama_kategori'] ?? '-') ?></div>
                                </div>
                            </div>
                            ...
                            <div class="metadata-item d-flex mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold small"><?= esc($artikel['nama'] ?? '-') ?></div>
                                </div>
                            </div>
