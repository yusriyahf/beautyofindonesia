...
<div class="dashboard-wrapper" style="padding: 20px; background: #f5f7fa;">
    ...
    <div class="sidebar" style="display: flex; flex-direction: column; gap: 20px;">
      ...
      <div class="quick-actions" style="background: white; border-radius: 12px; padding: 20px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
          <a href="<?= base_url('penulis/artikel/tambah') ?>" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 12px; background: #f3f4f6; border-radius: 8px; text-decoration: none; color: #4b5563; transition: all 0.2s;">
          ...
          <a href="<?= base_url('penulis/tempat_wisata/tambah') ?>" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 12px; background: #f3f4f6; border-radius: 8px; text-decoration: none; color: #4b5563; transition: all 0.2s;">
          ...
          <a href="<?= base_url('penulis/oleh_oleh/tambah') ?>" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 12px; background: #f3f4f6; border-radius: 8px; text-decoration: none; color: #4b5563; transition: all 0.2s;">
          ...
          <a href="<?= base_url('penulis/daftariklankonten') ?>" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 12px; background: #f3f4f6; border-radius: 8px; text-decoration: none; color: #4b5563; transition: all 0.2s;">
            <div style="width: 32px; height: 32px; background: #e0e7ff; border-radius: 6px; display: flex; align-items: center; justify-content: center; margin-bottom: 8px;">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4f46e5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect>
                <line x1="8" y1="21" x2="16" y2="21"></line>
          ...
          <?php
              if (!empty($aktivitas)) {
                ...
                foreach ($aktivitas_terakhir as $item):
                  ...
                  // Set title, warna, icon sesuai jenis aktivitas (bisa kamu sesuaikan lagi)
                  switch ($jenis) {
                    case 'komisi':
                  ...
                  // Cari judul konten dari $judulKontenIklan berdasarkan id_iklan
                  $judulDitemukan = null;
                  $idIklanAktif = $item['id_iklan'] ?? null;

                  if ($idIklanAktif && !empty($judulKontenIklan)) {
                    foreach ($judulKontenIklan as $jki) {
                      if ($jki['id_iklan'] == $idIklanAktif) {
                        $judulDitemukan = $jki['judul'];
                        break;
                      }
                    }
                  }
                  ...
                  <div style="display: flex; gap: 12px; align-items: center;">
                    ...
                    <div>
                      ...
                      <?php if ($judulDitemukan): ?>
                        <p style="font-size: 12px; color: #718096; margin: 0;">Judul Konten: <strong><?= htmlspecialchars($judulDitemukan) ?></strong></p>
                      <?php else: ?>
                        <p style="font-size: 12px; color: #718096; margin: 0; font-style: italic; color: #a0aec0;">Judul konten kosong</p>
                      <?php endif; ?>
  ...
  <div class="history-table" style="background: white; border-radius: 10px; padding: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <button onclick="window.location.href='<?= base_url('penulis/saldo')?>'" style="padding: 8px 16px; background: #4f46e5; color: white; border: none; border-radius: 6px; font-size: 14px; cursor: pointer;">
        Lihat Selengkapnya
      </button>
    </div>
