...
class TentangModel extends Model
{
    ...
    protected $allowedFields = ['id_tentang', 'nama_tentang', 'foto_tentang', 'deskripsi_tentang', 'deskripsi_tentang_en', 'alamat', 'no_telp', 'email', 'instagram', 'tiktok', 'youtube', 'footer',  'slogan'];
